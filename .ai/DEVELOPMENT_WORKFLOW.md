...
1. **Planning Mode**: Before executing complex implementations, produce an Implementation Plan outlining proposed changes. All milestones must use the official permanent milestone ID standard (e.g., M0.1, M1.0) to strictly track project progress.
